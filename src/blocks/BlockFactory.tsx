import { Temp_appFeedComponent, Temp_appComposerComponent } from './Temp_appApp'
...
export default class BlockFactory {
  static getFeedComponent(model: BlockModel) {
    switch (model.type) {
      ...
      case "Temp_app": return <Temp_appFeedComponent model={model} />;
  ...
  static getComposerComponent(props: ComposerComponentProps) {
    ...
    switch (model.type) {
      ...
      case "Temp_app": return Temp_appComposerComponent(props);
